...
class Display:
    ...
    def init(self, environment: BaseEnvironment):
        ...
        self.manager = pygame_gui.UIManager((SCREEN_WIDTH, SCREEN_HEIGHT), theme_path=environment.theme_path)

        self.background.fill(environment.background_colour)
