...
class UIFactory:
    ...
    @staticmethod
    def image(
        pos, size, image_path, manager, object_id=None, container=None, anchor=None
    ):
        ...
        if anchor is not None:
            ...
            rect.topleft = pos
        return UIImage(
            rect, loaded_image, manager, container=container, object_id=object_id
        )
    ...
    def button_img(
        ...
        button = Button(
            rect.topleft, size, text, manager, object_id=object_id, container=container
        )
...
class TypingTextBox(UITextBox):
    def __init__(self, pos, size, html_text, manager, object_id=None, container=None):
        super().__init__(
            "", Rect(pos, size), manager, container=container, object_id=object_id
        )
